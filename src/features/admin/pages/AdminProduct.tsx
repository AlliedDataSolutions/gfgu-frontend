...
import { columns } from "@/features/vendor/components/ProductGrid";
import { deleteProduct, useProductFilter } from "@/features/vendor/hooks/useProduct";
...
const AdminProduct: FC = () => {
  ...
  const editProduct = (id: string) => {
    navigate(`${paths.admin.editProduct.path}/${id}`);
  };
